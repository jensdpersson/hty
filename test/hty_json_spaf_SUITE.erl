...
-export([
    all/0, groups/0,
    empty_element/1, empty_attribute/1, element_with_text/1,
    empty_element_with_attributes/1, 
    element_with_text_and_attributes/1,
    element_with_elements_with_different_names/1, 
    element_with_elements_with_identical_names/1,
    element_with_elements_and_text/1]).
